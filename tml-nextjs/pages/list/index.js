...
export default function Main({ trades, db }) {
...
export async function getServerSideProps() {
  ...
  const reqs = await fetch("http://localhost:3000/api/db");
  const db = await reqs.json();
